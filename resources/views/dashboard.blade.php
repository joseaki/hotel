...
<head>
    ...
    <link rel="stylesheet" href="{{URL::asset(asset('/assets/css/material-dashboard.css?v=2.0.0'))}}">
    <!-- Documentation extras -->
    <!-- CSS Just for demo purpose, don't include it in your project -->
    <link rel="stylesheet" href="{{URL::asset(asset('/assets/assets-for-demo/demo.css'))}}">
    <!-- iframe removal -->
</head>
